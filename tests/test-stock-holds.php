...
class Test_Stock_Holds extends WP_UnitTestCase {
	...
	/** Holds cannot consume the protected safety buffer. */ public function test_holds_respect_safety_stock():void{global $wpdb;(new SafetyStockPolicyRepository($wpdb))->save($this->pool_id,3);$this->expectException(InvalidArgumentException::class);$this->service->place($this->pool_id,'quarantined',8,'Consumes buffer',7);}
