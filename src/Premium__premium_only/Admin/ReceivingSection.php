...
final class ReceivingSection implements ScreenSectionInterface {
	 ...
	 */
	public function __construct( SupplierRepository $suppliers, PoolRepository $pools, QuantityFormatter $formatter, BatchRepository $batches ) {
