...
final class Privacy {
	...
	public function add_privacy_policy_content(): void {
		$content  = '<p>' . __( 'Laqi Unit Stock Manager stores inventory pools, product-to-pool links, exact stock movements, and operational order references. When a logged-in user performs a manual adjustment, the movement records that WordPress user ID for accountability.', 'laqi-unit-stock-manager' ) . '</p>';
